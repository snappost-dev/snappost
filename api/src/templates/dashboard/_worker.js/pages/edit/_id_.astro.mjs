...
</div>`, addAttribute(String(post.title ?? ""), "value"), addAttribute(String(post.slug ?? ""), "value"), addAttribute(post.published === 1, "checked"), addAttribute(String(post.description ?? ""), "value"), defineScriptVars({ editorDataJson: editorData ? JSON.stringify(editorData) : "null" }));
